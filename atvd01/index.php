...
<body>
  ...
  <section id="sobre" class="hero">
    <div>
      ...
      <p>Edição limitada com apenas <?php echo $estoque; ?> unidades. Um item de colecionador para desenvolvedores e fãs da cultura dev.</p>
      <button class="btn"  id="btn-comprar">Garanta o Seu Agora</button>
    </div>
    <div>
  ...
  <section class="exclusivo">
    ...
    <button class="btn" id="btn-comprar">Comprar Agora</button>
  </section>
